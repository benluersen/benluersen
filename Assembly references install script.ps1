...
#Copies missing xlangs file to correct location
Copy-Item "\\tql.com\shares\BiztalkShares\Tools\Visual Studio 2015 Enterprise\Microsoft.XLANGs.BaseTypes.dll" -Destination "C:\Program Files (x86)\Microsoft Visual Studio 14.0\Common7\IDE\PublicAssemblies\"
...
Then Update Newtonsoft.Json. Find the latest "Newtonsoft.Json.dll" file on your pc with agent ransack and place it into C:\VSTS2016\TQL.BZT\Common\Assemblies.
Save and close Visual Studio. If you have done all the steps press yes to continue'
...
$title    = 'Please read'
$question = 'right click on AutoAcceptAsync add reference to build rules from "C:\VSTS2016\Projects\Rules\TQL.BZT.Rules.Utils\bin\Debug\"
add repositories.dll from "C:\VSTS2016\Projects\BLL\TQL.BZT.BLL\TQL.BZT.Repositories\bin\Debug\" as well
...
$title    = 'Please read'
$question = 'Add repositories.dll reference to async from "C:\VSTS2016\Projects\BLL\TQL.BZT.BLL\TQL.BZT.Repositories\bin\Debug\"
add reference to build rules from "C:\VSTS2016\Projects\Rules\TQL.BZT.Rules.Utils\bin\Debug\"
Save and close visual studio
Then click yes to continue'
$choices = New-Object Collections.ObjectModel.Collection[Management.Automation.Host.ChoiceDescription]
$choices.Add((New-Object Management.Automation.Host.ChoiceDescription -ArgumentList '&Yes'))
...
buildVS -path C:\VSTS2016\Projects\BLL\TQL.BZT.BLL\TQL.BZT.Repositories.AutoAcceptAsync\TQL.BZT.Repositories.AutoAcceptAsync.csproj
buildVS -path C:\VSTS2016\Projects\BLL\TQL.BZT.BLL\TQL.BZT.Controllers\TQL.BZT.Controllers.sln
